...
public class Event {
    ...
    public void updateFrom(Event updatedEvent) {
        ...
        if (updatedEvent.getTime() != null) {
            this.setTime(updatedEvent.getTime());
        }
        if (updatedEvent.getReminder() != null) {
            this.setReminder(updatedEvent.getReminder());
        }
        // Don't update user or status here - those are handled separately
    }
}